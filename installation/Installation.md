...
We provide required pretrained checkpoints via [huggingface](https://huggingface.co/YSZuo/Imagent-Toolbox-Pretrained-Models) and [Google Drive](https://drive.google.com/file/d/1cX1n_zFFteX6_1NeVtoitUi-A_azl7jD/view?usp=drive_link). For google drive, you can download them using gdown:  

```bash
pip install gdown
python -m gdown 1cX1n_zFFteX6_1NeVtoitUi-A_azl7jD
tar -xzvf Imagent_toolbox_pretrained_ckpts.tar.gz
rm -rf Imagent_toolbox_pretrained_ckpts.tar.gz
